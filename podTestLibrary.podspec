...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/张千通/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '张千通' => 'zhangqiantong@mucfc.com' }
  s.source           = { :git => 'https://github.com/张千通/podTestLibrary.git', :tag => s.version.to_s }
